        ...
        <div className="container">
            <div className="row">
                <div className="col-md-12">
                    <h1>Widow Pension</h1>
                    <p>  Write Widow Pension subtittle  or short discription here.</p>
                </div>
            </div>
        </div>
    </div>
...
{/* coacing img and text box here  */}
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <figure class="short-text-thumb"><img src="gallery_imgs/Gallery_img7.jpg" alt="" /></figure>
                    </div>
